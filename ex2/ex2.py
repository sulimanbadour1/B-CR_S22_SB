...
class Network:
    def __init__(self, env) -> None:
        ...
        self.pvariance = 0.1  #   initial parameters
        self.nhiddens = 5  # internal neurons
    ...
    def evaluate(self, nepis):
        for i_epi in range(nepis):
            self.cumultative_reward = 0
            observation = env.reset()
            print("Episode {}".format(i_epi))
            ...
            while not done:
                ...
                print("t = {}, reward = {}, cumulative_reward = {}".format(t, reward, self.cumultative_reward))
                t += 1
        print("Episode {} finish after {} timesteps".format(i_epi, t))
        print("Cumulative reward is : ", self.cumultative_reward)
        env.close()
        return reward
